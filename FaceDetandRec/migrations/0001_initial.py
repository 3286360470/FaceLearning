# Generated by Django 2.0.4 on 2019-04-26 09:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateField()),
                ('update_time', models.DateField()),
                ('oripics', models.ManyToManyField(to='FaceDetandRec.OriPic')),
            ],
        ),
        migrations.CreateModel(
            name='TarPic',
        ...
        migrations.AddField(
            model_name='record',
            name='tarpics',
            field=models.ManyToManyField(to='FaceDetandRec.TarPic'),
        ),
        migrations.AddField(
            model_name='record',
            name='users',
